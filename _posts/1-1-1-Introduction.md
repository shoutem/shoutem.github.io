...
## Create extension
Best way to understand the power of extensions, is to get your hands dirty. We'll start with [setting up your development environment](https://shoutem.github.io/docs/extensions/getting-started/development-environment).
