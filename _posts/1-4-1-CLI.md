...
Theme `Argo` is created `app/themes/Argo.js`.
Theme variables for the theme are created in file `server/themes/ArgoVariables.json`
File `extension.json` was modified.
```

- ##### shoutem env install

Installs environment for application
