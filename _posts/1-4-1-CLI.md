...
Authenticates you as developer. Enter your Shoutem credentials. If you're not a Shoutem user yet, sign up at [beta.builder.shoutem.com](https://beta.builder.shoutem.com).
...
https://builder.beta.shoutem.com/app/5128
```
...
https://builder.beta.shoutem.com/app/5127
```
...
Adds [schema]({{ site.baseurl }}/docs/extensions/getting-started/using-butt-storage) to the extension.
