...
<p class="image">
<img src='{{ site.baseurl }}/img/references/platform/system-extensions.png'/>
</p>
...
- **actions** - actions that can be attached to shortcuts (see [shoutem.auth](https://github.com/shoutem/extensions/tree/master/shoutem-auth) extension)
...
- modifying styling by [creating a new theme](/docs/extensions/tutorials/writing-a-theme)
- creating completely new [screen layouts](/docs/extensions/tutorials/screen-layouts)
- creating new screen layouts by [extending existing screens and overriding certain methods](/docs/extensions/tutorials/modifying-extensions)
...
Read more in [Modifying extensions](/docs/extensions/tutorials/modifying-extensions) tutorial.
