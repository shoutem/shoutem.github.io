...
Publishes the named extension. It also offers you the choice whether or not you want to install the extension into the cloned app. Furthermore, if the extension is already published, it lets you bump it's patch version (0.0.X).
...
? Do you want to install {{ site.example.devName }}.restaurants extension to the app {{ site.example.appId }}? Yes
Success
```
...
Packing extension... [OK]
Processing upload... [OK]
Uploading For Reference extension to Shoutem... [OK]
Publishing for-reference version 0.1.0... [OK]
